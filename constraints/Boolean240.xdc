...
# ============================================================================
# Boolean Board constraints for tron-build18 (top module: chipInterface)
# Only contains pins for ports that actually exist on the top module:
#   CLOCK_100, BTN[3:0], SW[15:0], PD1..PD8, LD[15:0],
#   D1_AN/D2_AN, D1_SEG/D2_SEG, hdmi_clk_n/p, hdmi_tx_n/p[2:0]
# ============================================================================

# 100 MHz oscillator
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33} [get_ports {CLOCK_100}]

# Bank 0 config voltage
set_property CFGBVS VCCO [current_design]
set_property CONFIG_VOLTAGE 3.3 [current_design]
...
# ---------------------------------------------------------------------------
# 7-Segment display 1  D1_AN[3:0] / D1_SEG[7:0]
# ---------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS33} [get_ports {D1_AN[0]}]
set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports {D1_AN[1]}]
set_property -dict {PACKAGE_PIN C7 IOSTANDARD LVCMOS33} [get_ports {D1_AN[2]}]
...
# ---------------------------------------------------------------------------
# 7-Segment display 2  D2_AN[3:0] / D2_SEG[7:0]
# ---------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN H3 IOSTANDARD LVCMOS33} [get_ports {D2_AN[0]}]
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {D2_AN[1]}]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports {D2_AN[2]}]
...
# ---------------------------------------------------------------------------
# PMOD D : controller inputs PD1..PD8 (pulldown so idle reads 0)
# ---------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN N4 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD1}]
set_property -dict {PACKAGE_PIN N5 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD2}]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD3}]
set_property -dict {PACKAGE_PIN R4 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD4}]
set_property -dict {PACKAGE_PIN T4 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD5}]
set_property -dict {PACKAGE_PIN R5 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD6}]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD7}]
set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {PD8}]